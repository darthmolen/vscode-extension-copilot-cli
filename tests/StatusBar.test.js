...
describe('StatusBar Component', () => {
	...
	describe('Rendering', () => {
		...
		it('should render reasoning checkbox', async () => {
			const { StatusBar } = await import('../src/webview/app/components/StatusBar/StatusBar.js');
			
			statusBar = new StatusBar(container);
			
			const checkbox = container.querySelector('#showReasoningCheckbox');
			assert.ok(checkbox, 'Should render reasoning checkbox');
			assert.strictEqual(checkbox.type, 'checkbox', 'Should be a checkbox');
		});
	...
	describe('Reasoning Checkbox', () => {
		it('should emit reasoningToggle event when checkbox changed', async () => {
			const { StatusBar } = await import('../src/webview/app/components/StatusBar/StatusBar.js');
			...
			assert.strictEqual(emittedValue, true, 'Should emit true when checked');
		});

		it('should get checkbox state with isReasoningEnabled()', async () => {
			const { StatusBar } = await import('../src/webview/app/components/StatusBar/StatusBar.js');
			...
			assert.strictEqual(statusBar.isReasoningEnabled(), true, 'Should return checkbox state');
		});

		it('should set checkbox state with setReasoningEnabled()', async () => {
			const { StatusBar } = await import('../src/webview/app/components/StatusBar/StatusBar.js');
			
			statusBar = new StatusBar(container);
			statusBar.setReasoningEnabled(true);
			
			const checkbox = container.querySelector('#showReasoningCheckbox');
			assert.strictEqual(checkbox.checked, true, 'Should set checkbox to checked');
		});
	});
