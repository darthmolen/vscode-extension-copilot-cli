...
| :construction: | Mid-session model switching | 3.3 | — | — | [model-selection-dropdown.md](../backlog/model-selection-dropdown.md) |
...
| :construction: | Compaction end should reset metrics | 3.3 | — | — |
...
| :construction: | Upgrade to @github/copilot-sdk 0.1.26 (breaking: required permission handler) | 3.3 | — | — | [RELEASE-0.1.23.md](../../documentation/copilot-sdk/RELEASE-0.1.23.md) |
