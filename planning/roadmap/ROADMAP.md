...
| :construction: | **v4.0 — AHP/ACP split** (Phase 0 complete) | 4.0 | — | — | [v4.0-ahp-acp-split.md](v4.0-ahp-acp-split.md) |
| :construction: | Event architecture transition — absorbed into the v4.0 split | 4.0 | — | — | [event-architecture-transition.md](../4.0/event-architecture-transition.md) |
